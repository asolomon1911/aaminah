        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 slider-left-wrapper">
                    ...
                    <p class="fs-5 text-primary margin-bottom-5">You decide <span class="text-black">how much and when you work!</span>
                    </p>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="p-4">
                        <p class="title text-start common-line-height">Available <br><span class="text-primary">Positions</span>
                        </p>
                        <p class="small-font"><strong>We currently have full and part time opportunities for staff that live near and can service
                            the following Georgia Counties:</strong></p>
                        <p class="small-font">Barrow, Carroll, Catoosa, Chattooga, Dade, Dawson, Douglas, Elbert,
                            Fannin, Fayette, Floyd,
                            Gilmer,
                            Gordon, Greene, Haralson, Heard, Henry, Jenkins, Lamar, Lumpkin, Macon, Murray, Paulding,
                            Pickens,
                            Pike, Rabun, Richmond, Rockdale, Schley, Screven, Towns, Union, and Walker.</p>
                    </div>
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <p class="small-font">
                                            ...
                                            • Ability to pass all vital background checks/screenings</p></div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                    ...
                                    <div class="accordion-body">
                                        <p class="small-font">
                                            <b>Job Status:</b> Remote Part time & Remote Full time positions available; 1099
                                                ...
                                                responsible for making decisions</p></div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <p class="small-font">
                                            <b>Job Status:</b> Remote Part time & Remote Full time positions available; 1099 Contractor. Fee
                                            for Service - hourly pay, flat rate assessments, plus mileage reimbursement; Flexible hours
                                            (weekends as needed)<br><br>
                                            <b>Description:</b> Provide case coordination and complete clinical assessments for individuals and
                                            families within the home, community, and office setting.<br><br>
                                            <b>Education:</b> Master’s Degree; Licensed Counselor or Social Worker with one of the following
                                            licenses: LPC, LCSW, LMFT, Associate License or license eligible with minimum of 5-year postgraduate experience<br><br>
                                            <b>Experience:</b> Minimum of one (1) year experience in a clinical/therapeutic role in the
                                            healthcare field or clinical environment (community-based/social s\ervices experience)
                                            providing clinical assessments<br><br>
                                            <b>Duties and Responsibilities:</b><br>
                                            • Build relationship and rapport with case managers, contractors, and community partners to
                                            ensure effective treatment and case collaboration<br>
                                            • Provide case coordination and case management for individuals receiving services<br>
                                            • Must be willing to commute and see clients in their home and community, as well as in-office<br>
                                            • Coordinate clinical services, including assigning cases, and requesting services<br>
                                            • Monitor clinical assessment referrals to ensure that services are completed efficiently and
                                            timely<br>
                                            • Perform clinical assessment services to include (Substance Abuse, Domestic Violence,
                                            Parental Fitness, Trauma, Comprehensive Client and Family Assessments, Bonding and
                                            Attachment)<br>
                                            • Document case notes in the online Electronic Health Record system (SP360)<br>
                                            • Maintain excellent communication and effective working relationships with other agency staff<br>
                                            ...
                                            confidentiality<br>
                                            • Decision Making and Problem Solving – Ability to make critical decisions and solve problems
                                            while following agency and partner policies and procedures<br>
                                            • Flexibility – Ability to adapt easily to changing conditions and work responsibilities<br>
                                            • Interpersonal Skills – Strong desire to support others and instruct in ways that empower<br>
                                            • Organization Skills – Must have planning skills with demonstrated ability to work<br>
                                            independently and exercise sound judgment<br>
                                            • Self-starter with commitment to customer service and professional demeanor<br>
                                            • Ability to pass all vital background checks/screening</p></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group m-2">
                                ...
                                <input type="text" name="first_name" class="form-control" required
                                       placeholder="Ex: John" value="{{old('first_name')}}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group m-2">
                                <label>Last Name *</label>
                                <input type="text" name="last_name" class="form-control" required placeholder="Ex: Deo" value="{{old('last_name')}}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group m-2">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group m-2">
                                ...
                                <select name="position" class="form-control" required>
                                    ...
                                    <option value="Transporter" @if(old('position') ==="Transporter") selected @endif>Transporter</option>
                                    <option value="Family Resource Specialist" @if(old('position') ==="Family Resource Specialist") selected @endif>Family Resource Specialist</option>
                                    <option value="Clinical Support Specialist" @if(old('position') ==="Clinical Support Specialist") selected @endif>Clinical Support Specialist</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group m-2">
                                ...
                                <input type="file" name="file" accept="application/pdf" class="form-control" placeholder="Upload Resume" value="{{old('file')}}">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group m-2">
                                ...
                                <textarea name="description" rows="4" class="form-control"
                                          placeholder="Comments">{{old('description')}}</textarea>
                            </div>
                        </div>
